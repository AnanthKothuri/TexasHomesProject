    ...
    return (
      ...
      >
        {tools_used.map((tool, index) => (
          <Card
            key={index}
            className="card-content mb-4 shadow-sm detail-card"
            style={{
              width: 190,
              padding: 7.5,
              paddingTop: 20,
    ...
    <>
      ...
      <div className="container text-center">
        ...
        <p style={{ fontSize: "1.5em", paddingLeft: 120, paddingRight: 120 }}>
          Join us at Texas Homes Project in our mission to assist homeless
          individuals in receiving the support they need. Our goal is to connect
          communities across Texas with local homeless shelters, support
          organizations, and upcoming volunteer opportunities. We aim to
          integrate disparate data sources in hopes of providing a consolidated
          point of access for those wishing to assist the homeless.
        </p>
      </div>

      {/* Team Member Cards */}
      <header
        className="container text-center page-header"
        style={{
          fontSize: 30,
          padding: 30,
          paddingBottom: 5,
      ...
      <div
        className="row row-cols-auto"
        style={{ justifyContent: "center", paddingTop: 7.5 }}
      >
        ...
        <div style={{ marginTop: 5 }}>
          <Link to="https://gitlab.com/shahmir-m/cs373-group-21">
            <Button
              ...
              style={{ marginRight: 17.5, fontFamily: "monospace" }}
            >
              <b>GitLab Repository</b>
            </Button>
          </Link>
          <Link to="https://documenter.getpostman.com/view/23353623/2sA2r545RR#6b31cf1e-1622-4bc1-be25-bda989164be8">
            <Button variant="outline-primary" className="tool-links">
              <b style={{ fontFamily: "monospace" }}>API Documentation</b>
            </Button>
          </Link>
        </div>
      </div>
