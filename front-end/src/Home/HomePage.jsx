      ...
      <div style={{ display: "flex", flexDirection: "column" }}>
        ...
        >
          <Col style={{ marginBottom: 30, fontSize: 26 }}>
            ...
            <p style={{ fontSize: 20, fontFamily: "NotoSans" }}>
              Texas Homes Project hopes to assist individuals experiencing
              homelessness in Texas. We hope to provide an internet platform
              that can connect people in need to homeless shelters, raise
              awareness for organizations working to assist homeless
              populations, and highlight local volunteer opportunities to aid
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <p style={{ fontSize: 18, fontFamily: "NotoSans-SemiBold" }}>
                Shelters
              </p>
              <p style={{ fontFamily: "NotoSans", fontSize: 15 }}>
                &#8226; Homeless shelters located throughout Texas
                <br />
                &#8226; Contains information on contact, websites, descriptions,
                etc.
              </p>

              <Link to="/shelters">
                <button style={getbuttonStyle(Colors.lightBlue)}>
                  View Shelters
                </button>
              </Link>
            </div>
          ...
          >
            ...
            >
              ...
              <p style={{ fontFamily: "NotoSans" }}>
                &#8226; Texas counties and their data about homelessness
                <br />
                &#8226; Contains information on county desciptions, housing
                units, population, and more.
              </p>

              <Link to="/counties">
                <button style={getbuttonStyle(Colors.lightYellow)}>
                  View Counties
                </button>
              </Link>
            </div>
          ...
          >
            ...
            >
              ...
              <p style={{ fontFamily: "NotoSans" }}>
                &#8226; Volunteering events in Texas for homelessness
                <br />
                &#8226; Contains about locations, dates, details, and
                requirements.
              </p>

              <Link to="/events">
                <button style={getbuttonStyle(Colors.lightRed)}>
                  View Events
                </button>
              </Link>
            </div>
